...
START_TEST(dec_int_test) {
    ...
    int dec_int_res_exp[] = {1, 222, 3333, 44444, 5555, -11, -2222, -332, -4123, -53412, 0, 123123, 4093890, -1234092, 999999, 90099909};
...
START_TEST(dec_float_test) {
    ...
    float dec_float_exp[] = {12.2, 123.562, 2123.123, 2342.12, 0.1231251, 2222.222};
    //normal
    for (int i = 0; i < (int) (sizeof(dec_float_exp) / sizeof(int)); i++) {
        s21_from_float_to_decimal(dec_float_exp[i], &dec);
